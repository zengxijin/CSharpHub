...
constraint pk_xnl_sys_cfg primary key (id)
...
--使用示例
--insert into xnl_sys_cfg(id,cfg_key,cfg_val,cfg_type,create_time) values(seq_xnl_sys_cfg.nextval,'mykey','myval','mytype',sysdate)
